...
?>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="txt_uname" placeholder="Vezetéknév" value="<?php if (isset($error)) {
                                    echo $vname;
                                } ?>" />
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="txt_uname" placeholder="Keresztnév" value="<?php if (isset($error)) {
                                    echo $kname;
                                } ?>" />
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="txt_uname" placeholder="Felhasználónév" value="<?php if (isset($error)) {
                                    echo $uname;
                                } ?>" />
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" name="txt_umail" placeholder="E-mail cím" value="<?php if (isset($error)) {
                                    echo $email;
                                } ?>" />
                                </div>
                                <div class="form-group">
                                    <input type="tel" class="form-control" name="txt_umail" placeholder="Telefonszám: +36" value="<?php if (isset($error)) {
                                    echo $telefon;
                                } ?>" />
                                </div>
                                <div class="form-group">
                                    <input placeholder="Születési Dátum" type="text" onfocus="(this.type = 'date')" class="form-control" name="txt_umail" placeholder="Születési Dátum" value="<?php if (isset($error)) {
                                    echo $szuldatum;
                                } ?>" />
                                </div>
